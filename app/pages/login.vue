  ...
  >
    ...
    >
      ...
      <input
        type="submit"
        value="Submit"
        class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded cursor-pointer"
      />
    </form>
  </main>
</template>
...
const onSubmit = () => {
  ...
  // tu normalnie byłoby fetch("/api/auth/login", ...)
  // ale robimy sam frontend
  console.log("Dane logowania:", form);

  komunikat.value = "✅ Zalogowano pomyślnie (mock)";
  setTimeout(() => {
